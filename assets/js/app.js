// regex for validation---used for validating inputs that should only contains letter and white spaces;
...
const mainForm = document.getElementById("cv-form"); //here form is exported to js
const validType = {
  TEXT: "text",
  TEXT_EMP: "text_emp",
  EMAIL: "email",
...
// user inputs elements                             ---all the inputs is assign by using there name attributes
...
// display elements                           ---here we assign  the print area inputs
...
//images is displaying by converting the json into the image src to display the image
